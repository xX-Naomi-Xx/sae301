 ...
 */
final class Version20251215105038 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client_services (client_id INT NOT NULL, services_id INT NOT NULL, INDEX IDX_5DD4D1AC19EB6921 (client_id), INDEX IDX_5DD4D1ACAEF5A6C1 (services_id), PRIMARY KEY (client_id, services_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
